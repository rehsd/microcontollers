...
STR_POST_POWER_ON:	.byte " -rehsd- Dual W65C265S 10 MHz R265Nibbler AVOS 0.02", 0
...
gfx_JumpToLineVRAM:
  .setting "RegA16", true
    ...
    gfx_JumpToLineVRAMLoop:
      jsr gfx_NextVGALineVRAM     ;there has to be a better way than to call this loop -- more of a direct calculation -- TBD
      dex
...
gfx_RestoreTile8:
    ...
    ; 3. Match DBR to VRAM bank (as your working code does)
    sep #$20
    lda vidpageVRAM+2
    pha
    plb
