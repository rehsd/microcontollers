...
;; On Chip RAM
  ...
  VIA0_PORTB 	      .equ VIA0_ADDR + VIA_PORTB
  VIA0_PORTA 	      .equ VIA0_ADDR + VIA_PORTA
  VIA0_DDRB  	      .equ VIA0_ADDR + VIA_DDRB
  VIA0_DDRA  	      .equ VIA0_ADDR + VIA_DDRA
  VIA0_T1CL  	      .equ VIA0_ADDR + VIA_T1C_L
  VIA0_T1CH  	      .equ VIA0_ADDR + VIA_T1C_H
  VIA0_T1LL  	      .equ VIA0_ADDR + VIA_T1L_L
  VIA0_T1LH  	      .equ VIA0_ADDR + VIA_T1L_H
  VIA0_T2CL  	      .equ VIA0_ADDR + VIA_T2C_L
  VIA0_T2CH  	      .equ VIA0_ADDR + VIA_T2C_H
  VIA0_SR    	      .equ VIA0_ADDR + VIA_SR
  VIA0_ACR   	      .equ VIA0_ADDR + VIA_ACR
  VIA0_PCR   	      .equ VIA0_ADDR + VIA_PCR
  VIA0_IFR   	      .equ VIA0_ADDR + VIA_IFR
  VIA0_IER   	      .equ VIA0_ADDR + VIA_IER

  ; VIA1 Address - %11010000:00000000:00000000 - $D0:0000
  ; VIA for expansion on expansion card
  VIA1_ADDR  	      .equ $D00000
  VIA1_PORTB 	      .equ VIA1_ADDR + VIA_PORTB
  VIA1_PORTA 	      .equ VIA1_ADDR + VIA_PORTA
  VIA1_DDRB  	      .equ VIA1_ADDR + VIA_DDRB
  VIA1_DDRA  	      .equ VIA1_ADDR + VIA_DDRA
  VIA1_T1CL  	      .equ VIA1_ADDR + VIA_T1C_L
  VIA1_T1CH  	      .equ VIA1_ADDR + VIA_T1C_H
  VIA1_T1LL  	      .equ VIA1_ADDR + VIA_T1L_L
  VIA1_T1LH  	      .equ VIA1_ADDR + VIA_T1L_H
  VIA1_T2CL  	      .equ VIA1_ADDR + VIA_T2C_L
  VIA1_T2CH  	      .equ VIA1_ADDR + VIA_T2C_H
  VIA1_SR    	      .equ VIA1_ADDR + VIA_SR
  VIA1_ACR   	      .equ VIA1_ADDR + VIA_ACR
  VIA1_PCR   	      .equ VIA1_ADDR + VIA_PCR
  VIA1_IFR   	      .equ VIA1_ADDR + VIA_IFR
  VIA1_IER   	      .equ VIA1_ADDR + VIA_IER

  ; VIA2 Address - %11011000:00000000:00000000 - $D8:0000
  ; VIA for expansion on expansion card
  VIA2_ADDR  	      .equ $D80000
  VIA2_PORTB 	      .equ VIA2_ADDR + VIA_PORTB
  VIA2_PORTA 	      .equ VIA2_ADDR + VIA_PORTA
  VIA2_DDRB  	      .equ VIA2_ADDR + VIA_DDRB
  VIA2_DDRA  	      .equ VIA2_ADDR + VIA_DDRA
  VIA2_T1CL  	      .equ VIA2_ADDR + VIA_T1C_L
  VIA2_T1CH  	      .equ VIA2_ADDR + VIA_T1C_H
  VIA2_T1LL  	      .equ VIA2_ADDR + VIA_T1L_L
  VIA2_T1LH  	      .equ VIA2_ADDR + VIA_T1L_H
  VIA2_T2CL  	      .equ VIA2_ADDR + VIA_T2C_L
  VIA2_T2CH  	      .equ VIA2_ADDR + VIA_T2C_H
  VIA2_SR    	      .equ VIA2_ADDR + VIA_SR
  VIA2_ACR   	      .equ VIA2_ADDR + VIA_ACR
  VIA2_PCR   	      .equ VIA2_ADDR + VIA_PCR
  VIA2_IFR   	      .equ VIA2_ADDR + VIA_IFR
  VIA2_IER   	      .equ VIA2_ADDR + VIA_IER
...
;********************* sound *************************
  PSG0_BC1          .equ %10000000    ; VIA0 Port B pins
  PSG0_BDIR         .equ %01000000 
  PSG1_BC1          .equ %00100000    
  PSG1_BDIR         .equ %00010000
;********************* /sound *************************
