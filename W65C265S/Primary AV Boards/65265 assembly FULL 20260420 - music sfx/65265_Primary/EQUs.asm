...
; PS/2 Keyboard
  ...
  ;VIA3 Address - %11010100:00000000:00000000 - $D4:0000
  ;Expansion card - PS/2 mouse, SNES gamepad
  VIA3_ADDR  	= $D40000
  VIA3_PORTB 	= VIA3_ADDR + VIA_PORTB
  VIA3_PORTA 	= VIA3_ADDR + VIA_PORTA
  VIA3_DDRB  	= VIA3_ADDR + VIA_DDRB
  VIA3_DDRA  	= VIA3_ADDR + VIA_DDRA
  VIA3_PCR   	= VIA0_ADDR + VIA_PCR
  VIA3_IFR   	= VIA3_ADDR + VIA_IFR
  VIA3_IER   	= VIA3_ADDR + VIA_IER

  ;VIA4 Address - %11011000:00000000:00000000 - $D8:0000
  ;Expansion card - expansion VIA
  VIA4_ADDR  	= $D80000
