...
void os_draw_sprite32x44(unsigned short x, unsigned short y, unsigned short sprite_id);
void os_tile_backup_32x44(unsigned short x, unsigned short y);
void os_tile_restore_32x44(unsigned short x, unsigned short y);
void os_tile_backup_32x44b(unsigned short x, unsigned short y);
void os_tile_restore_32x44b(unsigned short x, unsigned short y);

#define MUSIC_KUNGFU_THEME      0x11
#define MUSIC_OFF               0x12
