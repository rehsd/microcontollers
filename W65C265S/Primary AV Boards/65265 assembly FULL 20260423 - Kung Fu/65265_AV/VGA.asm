...
sprite_table_8:
  ...
  .byte $80, $00, $45, $00    ; ID 2: $450080 - Hit - white
...
sprite_table_32x44:
  ; --- Kung Fu - Thomas Left
  .byte $00, $00, $41, $00    ; Sprite 00: $410000
  .byte $80, $05, $41, $00    ; Sprite 01: $410580
  .byte $00, $0B, $41, $00    ; Sprite 02: $410B00
  .byte $80, $10, $41, $00    ; Sprite 03: $411080
  .byte $00, $16, $41, $00    ; Sprite 04: $411600
  .byte $80, $1B, $41, $00    ; Sprite 05: $411B80
  .byte $00, $21, $41, $00    ; Sprite 06: $412100
  .byte $80, $26, $41, $00    ; Sprite 07: $412680
  .byte $00, $2C, $41, $00    ; Sprite 08: $412C00
  .byte $80, $31, $41, $00    ; Sprite 09: $413180
  .byte $00, $37, $41, $00    ; Sprite 10: $413700
  .byte $80, $3C, $41, $00    ; Sprite 11: $413C80
  .byte $00, $42, $41, $00    ; Sprite 12: $414200
  .byte $80, $47, $41, $00    ; Sprite 13: $414780
  .byte $00, $4D, $41, $00    ; Sprite 14: $414D00
  ; --- Kung Fu - Thomas Right
  .byte $80, $52, $41, $00    ; Sprite 15: $415280
  .byte $00, $58, $41, $00    ; Sprite 16: $415800
  .byte $80, $5D, $41, $00    ; Sprite 17: $415D80
  .byte $00, $63, $41, $00    ; Sprite 18: $416300
  .byte $80, $68, $41, $00    ; Sprite 19: $416880
  .byte $00, $6E, $41, $00    ; Sprite 20: $416E00
  .byte $80, $73, $41, $00    ; Sprite 21: $417380
  .byte $00, $79, $41, $00    ; Sprite 22: $417900
  .byte $80, $7E, $41, $00    ; Sprite 23: $417E80
  .byte $00, $84, $41, $00    ; Sprite 24: $418400
  .byte $80, $89, $41, $00    ; Sprite 25: $418980
  .byte $00, $8F, $41, $00    ; Sprite 26: $418F00
  .byte $80, $94, $41, $00    ; Sprite 27: $419480
  .byte $00, $9A, $41, $00    ; Sprite 28: $419A00
  .byte $80, $9F, $41, $00    ; Sprite 29: $419F80
  ; --- Opponent 1 - Right
  .byte $00, $A5, $41, $00    ; Sprite 30: $41A500
  .byte $80, $AA, $41, $00    ; Sprite 31: $41AA80
  .byte $00, $B0, $41, $00    ; Sprite 32: $41B000
  .byte $80, $B5, $41, $00    ; Sprite 33: $41B580
  .byte $00, $BB, $41, $00    ; Sprite 34: $41BB00
  .byte $80, $C0, $41, $00    ; Sprite 35: $41C080  
...
gfx_DrawSprite32x44:
        ...
        lda sprite_table_32x44,x
        sta ptrsrc
        lda sprite_table_32x44+2,x
        sta ptrsrc+2
...
gfx_BackupTile32x44:
  ...
  @rowloopb32:
          ...
          lda vidpageVRAM
          clc
          adc #0480               ; Assuming backup area offset remains same
          sta ptrdest
...
; TO DO add param to consolidate and specify backup/restore location
gfx_BackupTile32x44b:
        php
        rep #$30
        pha
        phx
  ...
  @rowloopb32:
          ...
          lda vidpageVRAM
          clc
          adc #360                ; Assuming backup area offset remains same
          sta ptrdest2

          ldy #0
  @pixloopb32:
          lda (ptrvram2),y          ; Copying 16-bits (2 pixels) at a time
          sta (ptrdest2),y
          iny
          iny
          cpy #32                  ; 32 pixels wide
...
gfx_RestoreTile32x44b:
  ...
  @rowloopr32:
          ...
          ldy #0
  @pixloopr32:
          lda (ptrsrc2),y          ; Copying 16-bits (2 pixels) at a time
          sta (ptrdest2),y
          iny
          iny
          cpy #32                  ; 32 pixels wide
