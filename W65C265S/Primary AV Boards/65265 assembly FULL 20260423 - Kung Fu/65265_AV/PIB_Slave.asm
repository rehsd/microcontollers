...
IRQHandler_IRQPIB:
    ...
    @notplaysfx:
        ...
        cmp #PIB_CMD_DRAW_SPRITE_32x44
        bne @notsprite32x44
        jmp pib_draw_sprite_32x44
    @notsprite32x44:

        cmp #PIB_CMD_TILE_BACKUP_32x44
        bne @notbackup32x44
        jmp pib_tile_backup_32x44
    @notbackup32x44:

        cmp #PIB_CMD_TILE_RESTORE_32x44
        bne @notrestore32x44
        jmp pib_tile_restore_32x44
    @notrestore32x44:

        cmp #PIB_CMD_TILE_BACKUP_32x44b
        bne @notbackup32x44b
        jmp pib_tile_backup_32x44b
    @notbackup32x44b:

        cmp #PIB_CMD_TILE_RESTORE_32x44b
        bne @notrestore32x44b
        jmp pib_tile_restore_32x44b
    @notrestore32x44b:
