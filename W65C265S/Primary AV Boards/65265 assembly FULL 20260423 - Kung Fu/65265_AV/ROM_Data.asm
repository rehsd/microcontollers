...
; --- PSG 0 Registers ---
PSG0_A_FINE     .equ $00
PSG0_A_COARSE   .equ $01
PSG0_B_FINE     .equ $02
PSG0_B_COARSE   .equ $03
PSG0_C_FINE     .equ $04
PSG0_C_COARSE   .equ $05
PSG0_NOISE_PER  .equ $06
PSG0_MIXER      .equ $07
PSG0_A_VOL      .equ $08
PSG0_B_VOL      .equ $09
PSG0_C_VOL      .equ $0A
...
; --- PSG 1 Registers ---
PSG1_A_FINE     .equ $10
PSG1_A_COARSE   .equ $11
PSG1_B_FINE     .equ $12
PSG1_B_COARSE   .equ $13
PSG1_C_FINE     .equ $14
PSG1_C_COARSE   .equ $15
PSG1_NOISE_PER  .equ $16
PSG1_MIXER      .equ $17
PSG1_A_VOL      .equ $18
PSG1_B_VOL      .equ $19
PSG1_C_VOL      .equ $1A
...
SFX_KUNGFU_PUNCH:
        .byte PSG1_MIXER, $1E    ; mixer: tone a on, noise c on (%00011110)
        .byte PSG1_NOISE_PER, $06 ; sharp crack
        .byte PSG1_C_VOL, $0F    ; chan c volume max
        .byte $81                ; wait 1
        .byte PSG1_NOISE_PER, $0A ; thicker crunch
        .byte PSG1_C_VOL, $0C    ; volume decay
        .byte $81                ; wait 1
        .byte PSG1_NOISE_PER, $10 ; low thud
        .byte PSG1_C_VOL, $08    
        .byte $81                ; wait 1
        .byte PSG1_C_VOL, $00    ; silence
        .byte PSG1_MIXER, $3E    ; reset: tone a only
        .byte $FF

SFX_KUNGFU_KICK:
        .byte PSG1_MIXER, $16
        .byte PSG1_NOISE_PER, $12
        .byte PSG1_C_FINE, $60
        .byte PSG1_C_COARSE, $01
        .byte PSG1_C_VOL, $0F
        .byte $81
        .byte PSG1_NOISE_PER, $18
        .byte PSG1_C_FINE, $A0
        .byte $81
        .byte PSG1_NOISE_PER, $1E
        .byte PSG1_C_VOL, $0A
        .byte $82
        .byte PSG1_C_VOL, $00
        .byte PSG1_MIXER, $3E
...
// TO DO - Add support for loop count and indefinite loops
MUSIC_KUNGFU_THEME:
    ; https://musescore.com/user/24959521/scores/21595732
    .byte PSG0_MIXER, $38
    .byte PSG1_MIXER, $3E

    .byte $00, $f7, $01, $09, $08, $0F
    .byte $02, $fb, $03, $04, $09, $0F
    .byte $83   ; delay 3 ticks
    .byte $83   ; delay 3 ticks
    .byte $00, $f7, $01, $09, $08, $0F
    .byte $02, $fb, $03, $04, $09, $0F
    .byte $83   ; delay 3 ticks
    .byte $83   ; delay 3 ticks
    .byte $00, $fb, $01, $04, $08, $0F
    .byte $02, $fb, $03, $04, $09, $00
    .byte $83   ; delay 3 ticks
    .byte $83   ; delay 3 ticks
    .byte $00, $97, $01, $05, $08, $0F
    .byte $83   ; delay 3 ticks
    .byte $83   ; delay 3 ticks
