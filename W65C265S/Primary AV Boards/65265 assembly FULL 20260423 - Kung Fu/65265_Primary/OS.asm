...
cmd_get_date:       .byte "get_date"    ,0
cmd_set_date:       .byte "set_date"    ,0
cmd_get_time:       .byte "get_time"    ,0
cmd_set_time:       .byte "set_time"    ,0
cmd_get_temp:       .byte "get_temp"    ,0
cmd_test_sdcard:    .byte "test_sdcard" ,0
cmd_shell:          .byte "shell"       ,0
...
CommandTable:
    ...
    .word cmd_get_date,         do_get_date
    .word cmd_set_date,         do_set_date
    .word cmd_get_time,         do_get_time
    .word cmd_set_time,         do_set_time
    .word cmd_get_temp,         do_get_temperature
    .word cmd_test_sdcard,      do_test_sdcard
    .word cmd_shell,            do_shell
    .word 0,              0
