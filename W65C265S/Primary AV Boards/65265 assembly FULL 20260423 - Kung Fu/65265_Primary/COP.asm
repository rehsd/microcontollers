...
.word COP_draw_sprite_8         ; address for cop #$1E      ; Draw 8x8 sprite (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi, sprite_id_lo, sprite_id_hi
.word COP_backup_tile_8         ; address for cop #$1F      ; Backup 8x8 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; saves to shared RAM at $07:1200
.word COP_restore_tile_8        ; address for cop #$20      ; Restore 8x8 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; restores from shared RAM at $07:1200
.word COP_play_music            ; address for cop #$21      ; Play music (parameters in dpsram) - music ID_lo, music ID_hi, volume, loop flag
.word COP_play_sfx              ; address for cop #$22      ; Play sound effect (parameters in dpsram) - sfx ID_lo, sfx ID_hi, volume
.word COP_draw_sprite_32x44     ; address for cop #$23      ; Draw 32x44 sprite (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi, sprite_id_lo, sprite_id_hi
.word COP_backup_tile_32x44     ; address for cop #$24      ; Backup 32x44 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; saves to shared RAM at $07:1300
.word COP_restore_tile_32x44    ; address for cop #$25      ; Restore 32x44 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; restores from shared RAM at $07:1300
.word COP_backup_tile_32x44b    ; address for cop #$26      ; Backup 32x44 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; saves to shared RAM at $07:1300
.word COP_restore_tile_32x44b   ; address for cop #$27      ; Restore 32x44 tile (parameters in dpsram) - x_lo, x_hi, y_lo, y_hi; restores from shared RAM at $07:1300
...
COP_draw_sprite_32x44:
    ...
    .setting "RegXY16", true
    jsr copy_12_bytes_COP_to_PIB
    jsr pib_draw_sprite_32x44
    
    plb                 ; Restore original bank
    plp
    rts

COP_backup_tile_32x44:
    php
    phb
    sep #$20
    .setting "RegA16", false
    ...
    .setting "RegXY16", true
    jsr copy_12_bytes_COP_to_PIB
    jsr pib_tile_backup_32x44
    
    plb                 ; Restore original bank
    plp
    rts

COP_restore_tile_32x44:
    php
    phb
    sep #$20
    .setting "RegA16", false
    ...
    .setting "RegXY16", true
    jsr copy_12_bytes_COP_to_PIB
    jsr pib_tile_restore_32x44
    
    plb                 ; Restore original bank
    plp
    rts

COP_backup_tile_32x44b:
    php
    phb
    sep #$20
    .setting "RegA16", false
    ...
    .setting "RegXY16", true
    jsr copy_12_bytes_COP_to_PIB
    jsr pib_tile_backup_32x44b
    
    plb                 ; Restore original bank
    plp
    rts

COP_restore_tile_32x44b:
    php
    phb
    sep #$20
    .setting "RegA16", false
