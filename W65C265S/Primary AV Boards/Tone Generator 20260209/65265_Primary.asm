...
; ************** TO DO ****************************************
	...
	; find end of zero page - not everything currently fits - and move out some variables to another page
	;
; *************** /TO DO ***************************************
...
; ********** IMPORTANT NOTES **********************************
	...
	; Assembled for top 32 KB of 128 KB flash ROM IC (+$10000)
; ********** /IMPORTANT NOTES *********************************
...
; *********** MISC NOTES *******************************************
	...
	;	Caution: mvn parameter order for WDC816AS is:	mvn source, target
; *********** /MISC NOTES *******************************************
